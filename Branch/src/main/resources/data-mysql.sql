...
VALUES ('Rider', '1991-11-19 00:00:00', 'ed@gmail.com', 'Female', '234234', 'IDCARD', 'Karthik', 'J', 'Janakiram', '23423423', 'Miss.', 'ZoneB', (select address_id from address where area = 'dearborn'));
...
INSERT INTO ACTOR (roles, first_name, last_name, user_name, password, USER_TYPE, USER_TYPE_ID) 
	VALUES ('STANDARD_USER', 'Dummy', 'Head', 'dummy.head', '821f498d827d4edad2ed0960408a98edceb661d9f34287ceda2962417881231a', 'BRANCH', 
		(SELECT ID FROM BRANCH WHERE CONTACT_PERSON_FIRST_NAME = 'Prabhas')
	);
INSERT INTO ACTOR (roles, FIRST_NAME, LAST_NAME, user_name, password, USER_TYPE, USER_TYPE_ID) 
	VALUES ('BRANCH_USER,BRANCH_MANAGER,SYSTEM_MANAGER', 'ALEX' ,'ALEX', 'Alex123', '$2a$04$I9Q2sDc4QGGg5WNTLmsz0.fvGv3OjoZyj81PrSFyGOqMphqfS2qKu', 'BRANCH', 
		(SELECT ID FROM BRANCH WHERE CONTACT_PERSON_FIRST_NAME = 'Prabhas')
	);
INSERT INTO ACTOR (roles, FIRST_NAME, LAST_NAME, user_name, password, USER_TYPE, USER_TYPE_ID)
	VALUES ('BRANCH_ADMIN', 'TOM', 'TOM', 'Tom234', '$2a$04$PCIX2hYrve38M7eOcqAbCO9UqjYg7gfFNpKsinAxh99nms9e.8HwK', 'BRANCH', 
		(SELECT ID FROM BRANCH WHERE CONTACT_PERSON_FIRST_NAME = 'Prabhas')
	);
INSERT INTO ACTOR (roles, FIRST_NAME, LAST_NAME, user_name, password, USER_TYPE, USER_TYPE_ID)
	VALUES ('BRANCH_MANAGER', 'ADAM', 'ADAM', 'Adam', '$2a$04$I9Q2sDc4QGGg5WNTLmsz0.fvGv3OjoZyj81PrSFyGOqMphqfS2qKu', 'BRANCH', 
		(SELECT ID FROM BRANCH WHERE CONTACT_PERSON_FIRST_NAME = 'Prabhas')
	);
INSERT INTO ACTOR (roles, FIRST_NAME, LAST_NAME, user_name, password, USER_TYPE, USER_TYPE_ID)
	VALUES ('SYSTEM_MANAGER', 'Evelyn', 'M', 'Chang', '$2a$04$I9Q2sDc4QGGg5WNTLmsz0.fvGv3OjoZyj81PrSFyGOqMphqfS2qKu', 'BRANCH', 
		(SELECT ID FROM BRANCH WHERE CONTACT_PERSON_FIRST_NAME = 'Prabhas')
	);
...
INSERT INTO ORDER_INFO (NUMBER_OF_VESSELS, VESSEL_STATUS, ORDER_STATUS, CUSTOMER_ID, COUPON_CODE,  DATE_AND_TIME,  	PAYMENT_STATUS,  	TAX_AMOUNT,  	TAX_PERCENTAGE,  	TOTAL_AMOUNT,  	USER_NAME, ADDRESS_ID, BRANCH_ID, RIDER_ID)
...
(SELECT ID FROM RIDER WHERE RIDER_PERSON_FIRST_NAME = 'Lyla')
);
