...
values (3, 'NOT_RETURNED', 'PACKING', 1, '', current_timestamp, 'COMPLETED', 6, 6, 106, 'Alex123', 11, 1);
...
INSERT INTO ORDER_INFO (NUMBER_OF_VESSELS, VESSEL_STATUS, ORDER_STATUS, CUSTOMER_ID, COUPON_CODE,  DATE_AND_TIME,  	PAYMENT_STATUS,  	TAX_AMOUNT,  	TAX_PERCENTAGE,  	TOTAL_AMOUNT,  	USER_NAME, ADDRESS_ID, BRANCH_ID)
values (30, 'RETURNED', 'REJECTED', 2, '', current_timestamp, 'REFUNDED', 6, 6, 106, 'Alex123', 12, 1);
...
INSERT INTO ORDER_INFO (NUMBER_OF_VESSELS, VESSEL_STATUS, ORDER_STATUS, CUSTOMER_ID, COUPON_CODE,  DATE_AND_TIME,  	PAYMENT_STATUS,  	TAX_AMOUNT,  	TAX_PERCENTAGE,  	TOTAL_AMOUNT,  	USER_NAME, ADDRESS_ID, BRANCH_ID)
values (13, 'NOT_RETURNED', 'DELIVERED', 3, '', '2018-07-01 00:00:00', 'COMPLETED', 6, 6, 106, 'Alex123', 13, 1);
